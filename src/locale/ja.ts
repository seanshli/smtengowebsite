export const jaLocale = {
    ...
    product: {
        tablet_intro: {
            ...
            tagline: '家のことも、コミュニティのことも、一枚の壁に。',
            info: 'enGo AI スマートコントロールパネルは、家電操作・環境センシング・セキュリティ監視に加え、コミュニティのお知らせ、修理依頼、共用施設の予約、宅配通知をひとつに統合。外出先からはスマホアプリで同じように把握できます。'
        },
        brand_intro: {
            badge: '製品紹介',
        ...
        interfaces: {
            ...
            columns: { tablet: 'enGo3 壁掛けタブレット', ios: 'iPhone / iPad', android: 'Android スマートフォン' },
            rows: {
        ...
        tablet_function: {
            ...
            tabletOnly: 'タブレット専用',
            features: {
                voice: { title: '音声操作', body: '壁まで歩いて、ひと言話すだけ。「リビングの照明をつけて」「エアコンを26度に」「会議室の照明を全部消して」「退勤モード」——スマホを取り出す必要も、ボタンを探す必要もありません。安全に関わる機器は先に確認を求め、名前が似ている場合は推測せずに聞き返します。', note: 'システムが常時聞き取ることはなく、バックグラウンドで録音することもありません。' },
