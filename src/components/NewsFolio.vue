<template>
  ...
  >
    ...
    <div class="folio-scene">
      ...
      <!-- the "already read" pile under flipped pages -->
      <div class="folio-leftbase" aria-hidden="true">
...
export default defineComponent({
  ...
  setup(props) {
    ...
    return { locale, root, book, pageEls, shadeEls, page, flipping, tr, formatDate, next, prev, onPageClick }
  }
})
</script>
